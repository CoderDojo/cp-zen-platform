...
server.register(Scooter, function (err) {
  ...
  server.register({ register: Blankie, options: {
    ...
    frameAncestors: "'none'",
    imgSrc: "'self' data: http://52.17.20.218 http://*.coderdojo.com https://*.coderdojo.com https://www.google-analytics.com https://*.gstatic.com https://*.googleapis.com https://*.apis.google.com http://*.apis.google.com https://*.googlecode.com http://*.googlecode.com",
    manifestSrc: "'none'",
    mediaSrc: "'none'",
    objectSrc: "'none'",
    reflectedXss: 'block',
