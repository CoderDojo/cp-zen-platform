...
var po2json = require('po2json');  // eslint-disable-line import/no-extraneous-dependencies
var languages = require('../../config/languages');
var fs = require('fs');
var CpTranslations = require('cp-translations');  // eslint-disable-line import/no-extraneous-dependencies
...
module.exports = [
  {
    ...
    handler: function (request, reply) {
      var locale = (request.query && request.query.lang) ||
