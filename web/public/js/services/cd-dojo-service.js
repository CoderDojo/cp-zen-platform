  ...
  function cdDojoService($q, cdApi) {
    ...
    return {
      ...
      save: function(dojo, win, fail) {
        ...
        if (dojo.id) {
          cdApi.put('dojos/' + dojo.id, {
            dojo: dojo
          }, win, fail);
        } else {
          cdApi.post('dojo_create', {
            dojo: dojo
          }, win, fail || topfail);
        }
      },
      ...
      saveDojoLead: function(dojoLead, win, fail) {
        cdApi.post('dojos/save_dojo_lead', {
          dojoLead: dojoLead
        }, win, fail || topfail);
      },
