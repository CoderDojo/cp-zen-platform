  ...
  function(
    ...
    dojoUtils.isHavingPerm = function(user, dojoId, perm, userDojo) {
      function checkUserDojo(userDojo) {
        ...
        var isHavingPerm = _.find(userDojo[0].userPermissions, function(
          userPermission
        ) {
    ...
    dojoUtils.startingDojoSrcsWithDeprecated = dojoUtils.startingDojoSrcs.concat(
      [
        {
          id: 'organisations',
          name: $translate.instant(
            'Other Coding Organisations (no longer used)'
          ),
        },
        {
          id: 'developpers',
