...
//                   ng-click="toggleDatepicker($event, 'fromDatePicker')" ng-change="releaseDateBeforeEventDate()" id="date" />
...
//               <div class="input-group">
//                 <input name="toDate" type="date" ng-attr-min-date="isEditMode && eventInfo.dates[(eventInfo.dates.length-1)] || today" uib-datepicker-popup ng-model="eventInfo.toDate" is-open="datepicker.toDatePicker" ng-required="true" ng-readonly="true" ng-disabled="pastEvent" ng-class="{'selectable': !pastEvent}" current-text="{@i18n key="Today"/}" clear-text="{@i18n key="Clear"/}" close-text="{@i18n key="Done"/}" class="form-control"
//                  ng-click="toggleDatepicker($event, 'toDatePicker')" ng-change="updateLocalStorage('toDate', eventInfo.toDate)" id="to-date" />
//                 <span class="input-group-btn">
//                   <button type="button" class="btn btn-default" ng-click="toggleDatepicker($event, 'toDatePicker')">
//                     <i class="fa fa-calendar" aria-hidden="true"></i>
//                   </button>
//                 </span>
//               </div>
...
//         <div class="col-xs-12 col-md-9 form-group ticket-box" ng-repeat="session in eventInfo.sessions" ng-init="sessionIndex = $index">
...
//             </div>
//             {! My first attempt at making a calendar for inputting ticket release date but it is no longer meant to be inputted for each ticket. Just left this here as a reference.
//             <div class="col-sm-3">
//               <h5>{@i18n key="Ticket Release Date"/}</h5>
//             </div> !}
//             <div class="col-sm-2">
...
//         <!--DATE RELEASE -->
//
//         <!-- - add a checkbox and only display this if the box is ticked-->
//         <label> Ticket release </label>
//         <div ng-if="pastEvent">
//           <h5>{@i18n key="Event has passed"/}</h5>
//         </div>
//
//         <div ng-if="eventInfo.ticketsReleased">
//           <h5>{@i18n key="Tickets have been released"/}</h5>
//         </div>
//         <div class="row form-group" ng-if="!eventInfo.ticketsReleased && !pastEvent">
//           <div class="col-md-6">
//             <div class="check-release-date">
//                   {@i18n key="Date"/}:
//                 <div class="input-group">
//                   <input name="releaseDate" type="releaseDate" uib-datepicker-popup ng-model="eventInfo.releaseDate" is-open="datepicker2.fromDatePicker" ng-required="true" ng-readonly="true" ng-disabled="pastEvent"
...
//                   ng-click="toggleDatepicker2($event, 'fromDatePicker')" ng-change="updateLocalStorage('releaseDate', eventInfo.releaseDate)" id="releaseDate"/>
//                   <span class="input-group-btn">
//                     <button type="button"
//                     ng-disabled="pastEvent || eventInfo.ticketsReleased" class="btn btn-default" ng-click="toggleDatepicker2($event, 'fromDatePicker')">
//                       <i class="fa fa-calendar" aria-hidden="true"></i>
//                     </button>
//                   </span>
//                 </div>
//                 {@i18n key="Time"/}:
//                 <uib-timepicker id="ticket-release-time"
//                 name="releaseTime"
//                 ng-model="eventInfo.releaseDate"
//                 ng-change="updateLocalStorage('releaseDate', eventInfo.releaseDate)"
//                 hour-step="timepicker.hstep" minute-step="timepicker.mstep" show-meridian="timepicker.imderidian" class="timepicker"></uib-timepicker>
//             </div>
//           </div>
//         </div>
// {!
//         <div class="checkbox checkbox-block">
//           <input ng-disabled="pastEvent || eventInfo.ticketsReleased" type="checkbox" id="ticket-release" ng-model="eventInfo.ticketsReleased">
//           <label for="ticket-release">
//             {@i18n key="Ticket release <time></time>"/}
//           </label>
//           <i uib-tooltip="{@i18n key="This allows you to select a time and date that you want your tickets to be released. The default is the current date and time."/}" tooltip-placement="top" tooltip-animation="True" class="fa fa-info-circle event-tooltip"></i>
//         </div> !}
//
//
//         <!-- Date Release end -->
