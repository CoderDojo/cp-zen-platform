  ...
  server.route([
    {
      ...
      handler: handlers.actHandlerNeedsUser('save', null, null, {
        ctrl: 'lead',
      }),
      config: {
        auth: auth.apiUser,
    ...
    },
    {
      ...
      handler: handlers.actHandlerNeedsUser('submit', null, null, {
        ctrl: 'lead',
      }),
      config: {
        auth: auth.apiUser,
    ...
    },
    {
      method: 'DELETE',
      path: `${options.basePath}/dojos/lead/{id}`,
      handler: handlers.actHandlerNeedsUser('delete', 'id', null, {
        ctrl: 'lead',
      }),
      config: {
        auth: auth.apiUser,
