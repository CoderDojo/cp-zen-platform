...
exports.register = function(server, eOptions, next) {
  ...
  server.route([
    ...
    },
    {
      ...
      handler: handlers.actHandlerNeedsUser('update_image', [
        'dojoId',
        'avatar',
      ]),
      config: {
    ...
    },
    {
      ...
      handler: handlers.actHandlerNeedsUser('delete', 'dojoId', null, {
        ctrl: 'dojo',
      }),
      config: {
        auth: auth.apiUser,
    ...
    },
    {
      ...
      handler: handlers.actHandlerNeedsUser('joinedDojos', null, null, {
        ctrl: 'dojo',
      }),
      config: {
        auth: auth.apiUser,
        ...
        validate: {
          payload: Joi.object({
            data: {
              ...
              userType: Joi.string().required(),
              emailSubject: Joi.string()
                .valid('New Request to join your Dojo')
                .required(),
            },
          }),
        },
    ...
    },
    {
      ...
      path: `${
        options.basePath
      }/dojos/{dojoId}/request/{inviteToken}/user/{requestedByUser}`,
      handler(request, response) {
        return response().code(410);
      },
      config: {
        ...
        validate: {
          payload: Joi.object({
            userDojo: {
              ...
              userTypes: Joi.array(),
              userPermissions: Joi.alternatives().try(
                Joi.array(),
    ...
    },
    {
      ...
      handler: handlers.actHandlerNeedsUser('remove_usersdojos', [
        'userId',
        'dojoId',
      ]),
      config: {
          ...
          payload: Joi.object({
            data: {
              ...
              eventId: Joi.string()
                ...
                .required(),
              emailSubject: Joi.string()
                .valid('Tickets Now Available for %1$s')
                .required(),
            },
          }),
        },
    ...
    },
    {
      ...
      handler: handlers.actHandlerNeedsDojoAdmin(
        'export_dojo_users',
        'dojoId',
        'csv'
      ),
    ...
    },
    {
      ...
      handler: handlers.actHandler('search_join_requests', [
        'dojoId',
        'userType',
        'name',
      ]),
