...
exports.register = function(server, eOptions, next) {
  ...
  server.route([
    ...
    },
    {
      method: 'POST',
      path: `${options.basePath}/organisations`,
      handler: handlers.actHandlerNeedsUser('create', null, null, {
        ctrl: 'org',
      }),
      config: {
        auth: auth.apiUser,
    ...
    },
    {
      ...
      handler: handlers.actHandlerNeedsUser('list', ['orgId'], null, {
        ctrl: 'userOrg',
      }),
      config: {
        auth: auth.apiUser,
    ...
    },
    {
      ...
      handler: handlers.actHandlerNeedsUser('list', ['userId'], null, {
        ctrl: 'userOrg',
      }),
      config: {
        auth: auth.apiUser,
    ...
    },
    {
      ...
      handler: handlers.actHandlerNeedsCdfAdmin('list', null, {
        ctrl: 'userOrg',
      }),
      config: {
        auth: auth.apiUser,
    ...
    },
    {
      method: 'POST',
      path: `${options.basePath}/organisations/{orgId}/users`,
      handler: handlers.actHandlerNeedsUser('create', ['orgId'], null, {
        ctrl: 'userOrg',
      }),
      config: {
        auth: auth.apiUser,
