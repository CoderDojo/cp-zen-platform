...
exports.register = function (server, options, next) {
  ...
  server.route([{
    ...
    handler: handlers.actHandlerNeedsUser('load')
  }, {
    method: 'GET',
    ...
    handler: handlers.actHandlerNeedsCdfAdmin('number_of_champions_and_mentors_registered')
  }, {
    method: 'GET',
    path: options.basePath + '/kpi/number-of-youth-females-registered',
    handler: handlers.actHandlerNeedsCdfAdmin('number_of_youth_females_registered')
  }
]);
