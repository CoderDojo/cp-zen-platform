...
var ONE_YEAR_MS = 1 * 365 * 24 * 60 * 60 * 1000; // TODO move to config
...
module.exports = function (options) {
  ...
  seneca.act({ role: 'web', use: {
    ...
    pin: { role: plugin, cmd: '*' },
    map: {'list_countries': {GET: true, alias: 'countries', expiresIn: ONE_YEAR_MS },
      'list_places': {POST: true, alias: 'places'},
      'continents_lat_long': {GET: true, alias: 'continents_lat_long', expiresIn: ONE_YEAR_MS },
      'countries_lat_long': {GET: true, alias: 'countries_lat_long', expiresIn: ONE_YEAR_MS },
      'continent_codes': {GET: true, alias: 'continent_codes', expiresIn: ONE_YEAR_MS },
      'countries_continents': {GET: true, alias: 'countries_continents', expiresIn: ONE_YEAR_MS }
    }
  }});
