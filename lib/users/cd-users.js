...
module.exports = function(options){
  ...
  seneca.act({ role: 'web', use: {
    ...
    map: {
      ...
      // TODO this doesn't correctly get Cache-Control set.  My suspicion is that because the
      //      result is an array, the http$.headers data is deleted or disregarded somewhere
      //      within seneca-web.
