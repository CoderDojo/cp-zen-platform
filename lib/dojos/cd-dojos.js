...
module.exports = function (options) {
  ...
  seneca.add({role: plugin, cmd: 'load_usersdojos'}, proxyNeedUser);
  ...
  seneca.add({role: plugin, cmd: 'request_mentor_invite'}, proxy);
  seneca.add({role: plugin, cmd: 'accept_mentor_request'}, proxy);
  ...
  seneca.act({ role: 'web', use: {
    ...
    map: {
      ...
      'request_mentor_invite': {POST: true, alias: 'dojos/request_mentor_invite'},
      'accept_mentor_request': {POST: true, alias: 'dojos/accept_mentor_request'},
