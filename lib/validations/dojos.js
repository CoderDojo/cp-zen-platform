  ...
  var joiValidator = {
    ...
    champion: function (required) {
      var valid = {
        ...
        alternativeReference: Joi.string(),
        isValid: Joi.boolean()
      };
      if (required) {
        _.each(['firstName', 'lastName', 'email', 'dob', 'address',
         'phone', 'confidentCoding', 'confidentMentoring', 'coderDojoReference'],
          function (key) {
            valid[key].required();
          });
      }
    ...
    venue: function (required) {
      var valid = {
        ...
        country: Joi.string(),
        type: Joi.string(),
        alternativeType: Joi.string(),
        corporate: Joi.string(),
        alternativeCorporate: Joi.string(),
        isValid: Joi.boolean()
      };
      if (required) {
