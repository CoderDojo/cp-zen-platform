...
exports.register = function (server, options, next) {
  ...
  server.route([{
    ...
    config: {
      auth: auth.apiUser,
      description: 'Accept request from an user to join a dojo',
      notes: 'Accept request from an user to join a dojo',
      tags: ['api', 'dojos'],
      validate: {
        payload: {
          data: Joi.object({
  ...
  {
    method: 'POST',
    path: options.basePath + '/dojos/decline-user-request',
    handler: handlers.actHandlerNeedsUser('decline_join_request'),
    config: {
      auth: auth.apiUser,
      description: 'Decline request from an user to join a dojo',
      notes: 'Decline request from an user to join a dojo',
      tags: ['api', 'dojos'],
      validate: {
        payload: {
          data: Joi.object({
  ...
  },
  {
    ...
    handler: handlers.actHandler('search_join_requests', 'dojoId'),
    config: {
      auth: auth.apiUser,
