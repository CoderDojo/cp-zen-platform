...
exports.register = function (server, options, next) {
  ...
  },
  {
    ...
    config: {
      ...
      validate: {
        payload: Joi.object({ lead: {
          ...
          application: Joi.when('completed', {is: true, then: joiValidator.application(true),
           otherwise: joiValidator.application()}),
    ...
    handler: handlers.actHandlerNeedsUser('submit_dojo_lead'),
    config: {
      auth: auth.apiUser,
      description: 'lead',
      notes: 'lead',
      ...
      validate: {
        payload: Joi.object({ lead: {
          id: joiValidator.guid().optional(),
          application: joiValidator.application().required(),
          userId: joiValidator.guid().required(),
    ...
    method: 'GET',
    path: options.basePath + '/dojos/lead/user/{id}',
