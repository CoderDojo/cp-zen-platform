    ...
    config: {
      ...
      validate: {
        ...
        payload: Joi.object({ dojo: {
          ...
          mailingList: Joi.number().integer(),
          time: Joi.alternatives().try(Joi.string(), Joi.string().valid("")),
          country: joiValidator.country(),
          county: Joi.object().allow(null),
          state: Joi.object().allow(null),
          city: Joi.object().allow(null),
          ...
          googleGroup: Joi.alternatives().try(joiValidator.uri(), Joi.string().valid(null), Joi.string().valid("")),
          website: Joi.alternatives().try(joiValidator.uri(), Joi.string().valid("")),
          twitter: Joi.alternatives().try(joiValidator.twitter(), Joi.string().valid("")),
          ebId: Joi.any(),
