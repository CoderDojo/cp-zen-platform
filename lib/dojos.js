...
exports.register = function (server, options, next) {
  ...
  server.route([{
    ...
    handler: handlers.actHandlerNeedsDojoAdmin ('update', 'dojoId'),
    config: {
      description: 'Update',
      notes: 'Update',
      tags: ['api', 'dojos'],
    ...
    method: 'DELETE',
    path: options.basePath + '/dojos/{dojoId}',
    handler: handlers.actHandlerNeedsDojoAdmin('delete', 'dojoId'),
    config: {
    ...
    method: 'GET',
    path: options.basePath + '/dojos/export-users/{dojoId}',
