...
module.exports = function(options) {
  ...
  seneca.add({ role: plugin, cmd: 'listBadges'}, proxyNeedUser);
  seneca.add({ role: plugin, cmd: 'getBadge'}, proxyNeedUser);
  ...
  seneca.add({ role: plugin, cmd: 'loadBadgeCategories'}, proxyNeedUser);
