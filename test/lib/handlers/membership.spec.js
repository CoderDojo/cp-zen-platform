...
lab.describe('membership handler', () => {
  ...
  lab.describe('POST', () => {
    ...
    lab.test('it should create the membership', async () => {
      MembershipRequests.create.resolves({
        id: 'm1',
        userType: 'mentor',
        dojoId: 'd1',
        userId: 'u1',
    ...
    lab.test(
      'it should send a notification to the champion and the dojo',
      async () => {
        ...
        expect(Dojos.load).to.have.been.calledWith('d1', {
        ...
        expect(reply).to.have.been.calledOnce.and.calledWith({ id: 'm1' });
  ...
  lab.describe('PUT', () => {
    ...
    lab.test('it should create the membership', async () => {
      req.app.membershipRequest = {
        id: 'rq1',
        userType: 'mentor',
        dojoId: 'd1',
        userId: 'u1',
      };
      Memberships.create.resolves({
        id: 'm1',
        userTypes: ['mentor'],
        dojoId: 'd1',
        userId: 'u1',
  ...
  lab.describe('GET', () => {
    ...
    lab.test('it should load the existing join request', async () => {
      ...
      expect(MembershipRequests.load).to.have.been.calledOnce.and.calledWith(
        'rq1'
      );
